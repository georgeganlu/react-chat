        ...
        return (
            <div>
              ...
              { redirectTo&&path!==redirectTo?<Redirect to={this.props.redirect} />:null}
               ...
               <WhiteSpace size="xs" />
               <List>
                    <InputItem onChange={(v)=>this.handleChange(v,'title')}>招聘职位</InputItem>
                    <WhiteSpace size="xs" />
                    <InputItem onChange={(v)=>this.handleChange(v,'company')}>公司名称</InputItem>
                    <WhiteSpace size="xs" />
                    <InputItem onChange={(v)=>this.handleChange(v,'salary')}>公司薪资</InputItem>
                    <WhiteSpace size="xs" />
                    <TextareaItem title="职位要求" rows={5} count={100}  onChange={(v)=>this.handleChange(v,'desc')}  />
               </List>
               <WhiteSpace size="lg" />
